...
$fb = [
    'fb_app_id' => getenv('FB_APP_ID') ? getenv('FB_APP_ID') : '',
    'fb_app_secret' => getenv('FB_APP_SECRET') ? getenv('FB_APP_SECRET') : '',
];
...
$config = [
    ...
    'onesignal' => $onesignal,
    'fb' => $fb,
    'themeDir' => getenv("THEME_DIR") ?: 'default',
    'slugType' => getenv("SLUG_TYPE") ?: 2
];
